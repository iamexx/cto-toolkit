        ...
        <div className="absolute top-4 right-4 z-50">
          <div className="flex items-center gap-3 bg-[#1C1F3A]/80 backdrop-blur-sm rounded-lg px-4 py-2 border border-[#02E4B7]/30 shadow-lg">
            <div className="hidden sm:flex flex-col items-end mr-1">
              <span className="text-xs text-[#02E4B7]">Wallet</span>
              <span className="text-sm font-medium text-white">Connect to continue</span>
            </div>
            <WalletConnectButton className="bg-[#9945FF] hover:bg-[#7C3ADB] text-white text-xs sm:text-sm px-3 py-1 h-auto font-medium" />
          </div>
        </div>
